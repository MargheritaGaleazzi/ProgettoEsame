...
import org.json.*;
import gf.progettoesame.SpringBootApp.utility.Filtri;
import gf.progettoesame.SpringBootApp.utility.Filtriut;
 ...
 */
@Override
public ArrayList<Tweet> campoFiltro(String nomeCampo, String operatoreLogico, Object...valore){
	return (ArrayList<Tweet>) utils.select(this.getTimeline(), nomeCampo, operatoreLogico, valore);
}
/**
